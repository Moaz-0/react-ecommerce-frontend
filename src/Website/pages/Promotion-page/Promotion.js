...
function Promotion() {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(
      `https://ecommerce-backend-nkc0.onrender.com/api/products?populate=*&filters[sale][$eq]=true`
    )
      .then((res) => {
        return res.json();
      })
  ...
  return (
    <>
      ...
      />
      <h2 style={{textAlign:"center",margin:"20px 0 -60px 0",position:"relative",zIndex:"150"}}>Sale Products</h2>
